		...
		<div class="container-fluid red">
		  ...
		  <div class="col-md-6">
			...
			<?php foreach ($pro as $profi){ ?>
					...
					<?php endif; ?>
					<div class="tab">
						<button class="tablink active" onclick="openFolder(event, 'Inbox')" id="defaultOpen"><i class="lnr lnr-inbox"></i> Inbox&nbsp;<span class="badge bg-danger"><?php echo count($inb);?></span></button>
