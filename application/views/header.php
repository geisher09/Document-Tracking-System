<body>
<div class="row">
<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 tab-menu" style="margin: 0px;">
    <ul class="list-group" style="align: left;">
        <a href="<?php echo site_url('Home/home'); ?>" class="list-group-item text-center">
         <h3 class="glyphicon glyphicon-home"></h3><br/>Home
        </a>
        <a href="<?php echo site_url('Home/profile'); ?>" class="list-group-item text-center">
		...
		<a href="<?php echo site_url('Home/contacts'); ?>" class="list-group-item text-center">
         <h3 class="glyphicon glyphicon-phone"></h3><br/>Contacts
        </a>
		<a href="<?php echo site_url('Home'); ?>" class="list-group-item text-center">
