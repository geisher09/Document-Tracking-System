					...
					$.ajax({
						...
						success: function(data){
							...
							for(var i=0; i<parseInt(obj.recipient.length); i++){
									...
									+'</span></time><div class="cbp_tmicon cbp_tmicon-earth"></div><div class="cbp_tmlabel"><h2 id="sender2"><span class="glyphicon glyphicon-road"></span>&nbsp;'+obj.recipient[i].response+'</h2><p id="comment2">Employee:&nbsp;&nbsp;'+obj.recipient[i].lname+', '+obj.recipient[i].fname+' '+obj.recipient[i].lname
									+'<br/>Department:&nbsp;&nbsp;'+obj.recipient[i].department_desc
									+'<br/>Comment:&nbsp;&nbsp;'+obj.recipient[i].comment+'</p></h2></div>';
								...
								+'<br/>Status:&nbsp;&nbsp;'+obj.end.status
								+'<br/>By:&nbsp;&nbsp;'+obj.end.lname+', '+obj.end.fname+' '+obj.end.lname
								+'<br/>In department:&nbsp;&nbsp;'+obj.end.department_desc+'</p></h2></div>';
								$("#summary").html(summ);
								$('#flow').show(500);
